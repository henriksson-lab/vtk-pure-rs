...
impl ReferenceCount {
    /// VTK: `vtkReferenceCount::New`.
    pub fn new() -> Self {
        Self {
            object: Object::with_class_name("vtkReferenceCount"),
        }
    }
    ...
    /// VTK: `vtkReferenceCount::IsTypeOf`.
    pub fn is_type_of(name: &str) -> bool {
        name == "vtkReferenceCount" || Object::is_type_of(name)
    }

    /// VTK: `vtkReferenceCount::IsA`.
    pub fn is_a(&self, name: &str) -> bool {
        Self::is_type_of(name)
    }

    /// VTK: `vtkReferenceCount::GetNumberOfGenerationsFromBaseType`.
    ...
    /// VTK: `vtkReferenceCount::GetNumberOfGenerationsFromBase`.
