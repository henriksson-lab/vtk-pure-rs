use crate::common::{
    ...
    data_model::{DataSetAttributes, DataSetAttributesError, HIDDENCELL, REFINEDCELL},
};

/// Cell attribute data.
///
/// VTK origin: `VTK/Common/DataModel/vtkCellData.h` and
/// `VTK/Common/DataModel/vtkCellData.cxx`.
...
impl CellData {
    ...
    pub fn new() -> Self {
        ...
        attributes.set_ghosts_to_skip(HIDDENCELL | REFINEDCELL);
        Self { attributes }
    }

    /// VTK: `vtkCellData::ExtendedNew`.
    pub fn extended_new() -> Self {
        Self::new()
    }

    /// VTK: `vtkCellData::PrintSelf`.
