...
impl ParametricTorus {
    /// VTK: `vtkParametricTorus::New`.
    pub fn new() -> Self {
        let mut base = ParametricFunction::with_class_name("vtkParametricTorus");
    ...
    /// VTK: `vtkParametricTorus::SetRingRadius`.
    ...
    /// VTK: `vtkParametricTorus::GetRingRadius`.
    pub fn get_ring_radius(&self) -> f64 {
        self.ring_radius
    }

    /// VTK: `vtkParametricTorus::SetCrossSectionRadius`.
    ...
    /// VTK: `vtkParametricTorus::GetCrossSectionRadius`.
...
impl ParametricFunctionApi for ParametricTorus {
    ...
    /// VTK: `vtkParametricTorus::GetDimension`.
    fn get_dimension(&self) -> i32 {
        2
    }

    /// VTK: `vtkParametricTorus::Evaluate`.
    fn evaluate(&self, uvw: [f64; 3], pt: &mut [f64; 3], duvw: &mut [f64; 9]) {
        ...
        let cv = v.cos();
        let sv = v.sin();
        let t = self.ring_radius + self.cross_section_radius * cv;

        pt[0] = t * su;
        pt[1] = t * cu;
        pt[2] = self.cross_section_radius * sv;

        duvw[0] = t * cu;
        duvw[1] = -t * su;
        duvw[2] = 0.0;
        duvw[3] = -self.cross_section_radius * sv * su;
        duvw[4] = -self.cross_section_radius * sv * cu;
        duvw[5] = self.cross_section_radius * cv;
        duvw[6] = 0.0;
        duvw[7] = 0.0;
        duvw[8] = 0.0;
    }

    /// VTK: `vtkParametricTorus::EvaluateScalar`.
    fn evaluate_scalar(&self, _uvw: [f64; 3], _pt: [f64; 3], _duvw: [f64; 9]) -> f64 {
        0.0
    }
}

impl Default for ParametricTorus {
    fn default() -> Self {
        Self::new()
    }
}
