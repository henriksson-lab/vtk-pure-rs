...
pub struct ParametricSuperEllipsoid {
...
impl ParametricSuperEllipsoid {
    /// VTK: `vtkParametricSuperEllipsoid::New`.
    pub fn new() -> Self {
        let mut base = ParametricFunction::with_class_name("vtkParametricSuperEllipsoid");
        base.set_minimum_u(-pi());
        base.set_maximum_u(pi());
        base.set_minimum_v(-pi() / 2.0);
        base.set_maximum_v(pi() / 2.0);
    ...
    /// VTK: `vtkParametricSuperEllipsoid::SetXRadius`.
    ...
    /// VTK: `vtkParametricSuperEllipsoid::GetXRadius`.
    pub fn get_x_radius(&self) -> f64 {
        self.x_radius
    }

    /// VTK: `vtkParametricSuperEllipsoid::SetYRadius`.
    ...
    /// VTK: `vtkParametricSuperEllipsoid::GetYRadius`.
    pub fn get_y_radius(&self) -> f64 {
        self.y_radius
    }

    /// VTK: `vtkParametricSuperEllipsoid::SetZRadius`.
    ...
    /// VTK: `vtkParametricSuperEllipsoid::GetZRadius`.
    pub fn get_z_radius(&self) -> f64 {
        self.z_radius
    }

    /// VTK: `vtkParametricSuperEllipsoid::SetN1`.
    ...
    /// VTK: `vtkParametricSuperEllipsoid::GetN1`.
    pub fn get_n1(&self) -> f64 {
        self.n1
    }

    /// VTK: `vtkParametricSuperEllipsoid::SetN2`.
    ...
    /// VTK: `vtkParametricSuperEllipsoid::GetN2`.
...
impl ParametricFunctionApi for ParametricSuperEllipsoid {
    ...
    /// VTK: `vtkParametricSuperEllipsoid::GetDimension`.
    fn get_dimension(&self) -> i32 {
        2
    }

    /// VTK: `vtkParametricSuperEllipsoid::Evaluate`.
    fn evaluate(&self, uvw: [f64; 3], pt: &mut [f64; 3], duvw: &mut [f64; 9]) {
        ...
        let tmp = sgn_power(cv, self.n1);

        pt[0] = self.x_radius * tmp * sgn_power(su, self.n2);
        pt[1] = self.y_radius * tmp * sgn_power(cu, self.n2);
        pt[2] = self.z_radius * sgn_power(sv, self.n1);
    }

    /// VTK: `vtkParametricSuperEllipsoid::EvaluateScalar`.
    fn evaluate_scalar(&self, _uvw: [f64; 3], _pt: [f64; 3], _duvw: [f64; 9]) -> f64 {
        0.0
    }
}

impl Default for ParametricSuperEllipsoid {
    fn default() -> Self {
        Self::new()
    }
}
