//! Decomposition accumulated degree days
use crate::data::{AnyDataArray, DataArray, ImageData};
pub fn image_decomposition_rate(input: &ImageData, scalars: &str) -> ImageData {
...
mod tests {
    ...
    #[test]
    fn computes_decomposition_accumulated_degree_days() {
        let img = image(&[-2.0, 0.0, 3.0]);
        let r = image_decomposition_rate(&img, "v");
