...
pub fn image_deconfinement(input: &ImageData, scalars: &str) -> ImageData {
...
mod tests {
    ...
    #[test]
    fn computes_deconfinement_transition() {
        let img = image(&[0.0, 0.2, 0.4]);
        let r = image_deconfinement(&img, "v");
