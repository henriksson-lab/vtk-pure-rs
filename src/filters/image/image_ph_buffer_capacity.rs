...
pub fn image_ph_buffer_capacity(input: &ImageData, scalars: &str) -> ImageData {
...
mod tests {
    ...
    #[test]
    fn computes_ph_buffer_capacity() {
        let img = image(&[-1.0, 0.5, 2.0]);
        let r = image_ph_buffer_capacity(&img, "v");
        ...
        assert_close(
            ...
            &[2.303 * 0.01 * 0.99, 2.303 * 0.5 * 0.5, 2.303 * 0.99 * 0.01],
        );
    }
}
