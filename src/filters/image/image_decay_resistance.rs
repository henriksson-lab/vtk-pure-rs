//! Decay resistance index
use crate::data::{AnyDataArray, DataArray, ImageData};
pub fn image_decay_resistance(input: &ImageData, scalars: &str) -> ImageData {
...
mod tests {
    ...
    #[test]
    fn computes_decay_resistance_index() {
        let img = image(&[-10.0, 0.0, 20.0]);
        let r = image_decay_resistance(&img, "v");
        ...
        assert_close(
            ...
            &[5.0 * 0.1f64.exp(), 5.0, 5.0 * (-0.2f64).exp()],
        );
    }
}
