//! Defect sizing (dB drop)
use crate::data::{AnyDataArray, DataArray, ImageData};
pub fn image_defect_sizing(input: &ImageData, scalars: &str) -> ImageData {
...
mod tests {
    ...
    #[test]
    fn computes_defect_sizing_db_drop() {
        let img = image(&[1.0, 4.0]);
        let r = image_defect_sizing(&img, "v");
        ...
        assert_close(
            ...
            &[10.0f64.powf(-6.0 / 20.0), 4.0 * 10.0f64.powf(-6.0 / 20.0)],
        );
    }
}
