//! Deflagration flame speed
use crate::data::{AnyDataArray, DataArray, ImageData};
pub fn image_deflagration_speed(input: &ImageData, scalars: &str) -> ImageData {
...
mod tests {
    ...
    #[test]
    fn computes_deflagration_flame_speed() {
        let img = image(&[300.0, 600.0]);
        let r = image_deflagration_speed(&img, "v");
