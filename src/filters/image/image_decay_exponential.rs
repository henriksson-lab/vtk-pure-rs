...
pub fn image_decay_exponential(input: &ImageData, scalars: &str) -> ImageData {
...
mod tests {
    ...
    #[test]
    fn computes_exponential_decay_from_abs_value() {
        let img = image(&[-2.0, 0.0, 3.0]);
        let r = image_decay_exponential(&img, "v");
