...
///
/// Re-exported from [`crate::filters::mesh::mesh_remove_faces`], which holds the
/// single implementation (it additionally preserves verts/lines/strips and remaps
/// point and cell data).
pub use crate::filters::mesh::mesh_remove_faces::remove_small_faces;
