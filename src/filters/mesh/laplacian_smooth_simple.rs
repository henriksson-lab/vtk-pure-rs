...
///
/// Thin wrapper with the historical argument order; the single implementation
/// lives in [`crate::filters::mesh::smooth_taubin`].
pub fn taubin_smooth(mesh: &PolyData, iterations: usize, lambda: f64, mu: f64) -> PolyData {
    crate::filters::mesh::smooth_taubin::taubin_smooth(mesh, lambda, mu, iterations)
}
